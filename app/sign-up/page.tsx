      ...
      <main className="flex-grow flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold text-dark-gray mb-2 font-montserrat">Create an Account</h2>
            <p className="text-gray-600">Join SupplyStack to find construction materials faster</p>
          </div>
